...
{
    protected $fillable = ['user_id','proxy_id','reception_id','matter_type','matter_request_date','matter_reply_date','matter_change_date','order_content',
            'work_content','reject_content','purchase_content','matter_name','status','hour1','hour2','minutes1','minutes2','breaktime','allotted','allotted2','opt1','opt2','nendo'];
