...
class MatterTotalController extends Controller
{
    ...
    public function total_pa(){
        ...
        ->select(
            'users.id','users.name','users.start_date','users.employee','users.hiring_period','users.worktype_id',
            ...
            ->groupBy('users.id','users.start_date','users.name','users.employee','users.hiring_period','users.worktype_id')
        ...
        $userlist2 = User::leftJoin('matters', function($join) use ($startDate2, $endDate2) {
            ...
            ->select(
                ...
                ->groupBy('users.id','users.name','users.start_date','users.employee','users.hiring_period','users.worktype_id')
                ->orderby('users.employee')
                ->get();
