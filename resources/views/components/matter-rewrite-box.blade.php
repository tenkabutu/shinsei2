			...
			<h5>　振替作業情報</h5>
				<fieldset>
					...
					<div>
						...
						<input type="number"   class="minutes1" min="0" max="59" autocomplete="off" value="{{old('minutes1',$matter->minutes1)}}">
						</div>
						<label class="g34">終了時間</label>
						<div class="g45">
						<input type="number"   class="hour2"  autocomplete="off" value="{{old('hour2',$matter->hour2)}}">

						<input type="number"   class="minutes2" min="0" max="59" autocomplete="off" value="{{old('minutes1',$matter->minutes2)}}">
						</div>
