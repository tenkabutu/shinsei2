<section>
	<fieldset>
		<div>
			@if($role==1)
			<input type="submit" class="g12" value="承認" onclick="setAction('accept_te')">
			 <input type="submit" class="g23" value="再提出" onclick="setAction('redo_te')">
			 <input type="submit" class="g34" value="却下" onclick="setAction('reject_te')">
