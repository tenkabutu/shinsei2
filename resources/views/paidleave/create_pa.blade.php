...
<div id="modal_paidleave" class="detail_modal">
    <div class="modal_content">
        ...
        <h4>年次有給休暇</h4>
        <ul>
            <li><strong>単位：</strong>1日、半日、または時間単位で取得可能。</li>
            <li><strong>時間単位の制限：</strong>1年につき最大40時間（所定6時間勤務の方は30時間）まで。</li>
       		<li><strong>社員は毎年5日以上の有給休暇を取得する義務があります。</strong></li>
            <li>※注意：時間単位の有休は「年5日取得義務」のカウントに入りません。
            「日または半日」で5日以上取得が必要です。</li>

            <li><strong>［変更］：</strong>特別な勤務体系の社員が半休を取得する場合に使用。</li>

        <li>申請時間が「所定労働時間の半分」になっていることを確認してください。</li>
         </ul>
        <br>
...
<div id="modal_kekkin" class="detail_modal">
    <div class="modal_content">
        ...
        <ul>
            ...
            <li>
                <strong>[時間欠勤]：</strong>
                [遅刻]・[早退]以外の短時間の欠勤に使う区分
                <br>
                ＜使用例＞<br>
　1）有給の時間休が足りない社員が、「有給休暇（時間）」＋「時間欠勤」 を組み合わせて取得するとき
<br>
　2）有給休暇を持たない社員が、「振替休暇（時間）」＋「時間欠勤」 を組み合わせて取得するとき
<br>
　3）有給休暇を持たない社員が、勤務中に一時的に抜けて休む（中抜け）とき
            </li>
        </ul>
...
<div id="modal_special" class="detail_modal">
    <div class="modal_content">
        ...
        <ul>
            ...
            <li><strong>日数</strong>：対象家族1名につき年5日（2名以上の場合は年10日まで）</li>
            <li><strong>単位</strong>：1日または時間単位で取得（時間単位は所定労働時間に準ず）</li>
            <li><strong>必要書類</strong>：この申請とは別に<strong>「休暇申出書」</strong>および<strong>「証明書類」</strong>の提出が必要</li>
        </ul>
