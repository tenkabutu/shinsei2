    ...
    <h3>トップページ</h3>
     <fieldset>
				...
				<li class="text-danger">
					現在、「休暇申請情報」に表示されている有給残数は、昨年度の付与日数および一昨年度からの持越分が反映された状態となっております。<br>
有給休暇の申請自体は可能ですが、今年度分の付与日数および昨年度からの持越日(時)数については、4月9日以降に正しい情報へ更新される予定です。<br>
(※4月1日に始めて有給が付与される方は2号への申請は9日以降に行ってください)<br>
(※なお、後期入社の方については、10月8日頃の反映となります。)
<br>
ご不便をおかけいたしますが、反映まで今しばらくお待ちいただきますようお願いいたします。
</li>
