<x-app-layout>
    ...
    <h3>トップページ</h3>
     <fieldset>
				<legend>info</legend>
				<ul>
					<li>2022年度分の持ち越しはこれから数えるので(秋吉さんが)後日加算されます</li>
					<li>振替は許可済みであっても、振替日の作業時間と振替先の作業時間が一致しないと完了扱いになりません</li>
					<li>この画面には直近の貸出予定と休暇予定などを記載する予定</li>
					<li>4月1日までに登録した人の分は有給を設定しました、それ以降に登録した人の分は後日設定します。</li>
					<li>削除機能を実装しました。</li>
				</ul>
				</fieldset>
				 <fieldset>
					...
					<ul>
						...
						<li>リーダーの承認機能で、却下ボタンがありますが未実装です。</li>
					</ul>
				</fieldset>
				 <fieldset>
					<legend>不具合</legend>
					<ul>
						<li>申請一覧画面の表示がおかしくなっているので各申請ごとに修正と合わせて各項目ごとに分けます。尚不具合は一覧表示のみで申請自体は正常にできているので申請は可能です。</li>
