<x-app-layout><main>
    ...
    <h3>トップページ</h3>
     <fieldset>
				<legend>info</legend>
				<ul>
				<!-- 	<li class="text-bold">2025年度(令和7年度)の有給休暇申請をされる方へ<br>
					2025年度の有給休暇の付与は4月1日付※１となります。<br>
　※１　2023年4月1日～9月30日入社、2024年4月1日～9月30日入社の方は10月1日付与です。<br>
また、2024年度の有給休暇の残日数/残時間数は3月分の勤怠確認の後になりますので、4月8日頃を予定しています。それまで持越有給は未確定ですのでご了承願います。
</li> -->
				...
				<legend>駐車</legend>
				<p class="text-danger">江越旧事務所、木下第2駐車場の使用は終了しました</p>
				<img width="350" alt="" src="/shinsei2/public/img/egoe_park.png">
