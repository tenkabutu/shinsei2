<x-app-layout>
    ...
    <h3>トップページ</h3>
     <fieldset>
				<legend>info</legend>
				<ul>
					<li class="text-bold">2024年度(令和6年度)の有給休暇申請をされる方へ<br>
					2024年度の有給休暇の付与は4月1日付※１となります。<br>
　　※１2023年4月1日～9月30日入社の方は10月1日付<br>
また、2023年度の有給休暇の残日数/残時間数は3月分の勤怠確認の後になりますので、4月8日頃を予定しています。それまで持越有給は未確定ですのでご了承願います。
</li>
