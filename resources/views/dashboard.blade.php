<x-app-layout>
    ...
    <h3>トップページ</h3>
     <fieldset>
				<legend>info</legend>
				<ul>
					<li class="text-bold">・2024年度の有給休暇の付与は4月1日付となります。<span class="text-small">（2023年4月1日～9月30日入社の方は10月1日付）</span></li>
					<li class="text-bold">・2023年度の有給休暇の残日数/残時間数は3月分の勤怠確認の後になりますので、4月8日頃を予定しています。それまで持越有給は未確定ですのでご了承願います。</li>
					<li class="text-bold">・申請2号での2024年度有給の表示は上記確認後となりますので、4月8日以降になります。</li>
