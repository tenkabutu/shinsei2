<x-app-layout>
    ...
    <h3>トップページ</h3>
     <fieldset>
				<legend>info</legend>
				<ul>
					<li>・2022年度分の持ち越しはこれから数えるので(秋吉さんが)後日加算されます(4月中旬)</li>
				...
				<ul>
					...
					<li>・4月1日までに登録した人の分は有給を設定しました、それ以降に登録した人の分は持ち越し有給付与時に設定します。</li>
					<li>・有給を申請した場合、現在は今年の付与有給から引かれますが、持ち越し分が設定されると再計算され持ち越し分から引かれます。</li>
					<li>・申請の削除機能を実装しました。</li>
					<li>・許可済みのものは更新できないようにしました。(修正手段の仕様検討中)</li>
				 ...
				 <fieldset>
					...
					<ul>
						...
						<li>・リーダーの承認機能で、却下・再提出ボタンがありますが未実装です。</li>
				 ...
				 <fieldset>
					<legend>不具合</legend>
					<ul>
						<li>・休暇申請許可一覧で未申請や全件で担当以外の申請が表示される。</li>
						<li>・上記以外で気づいた点があればサイボウズなどでご連絡ください。</li>
					</ul>
				</fieldset>
