		 ...
		 @if (Route::has('login'))
		 	@auth
				...
				<ul>
					...
					<li class="nav_count"><a href="/shinsei2/public/7/matter_ruling">購入申請</a>　　　　<a class="double" href="/shinsei2/public/7/matter_ruling?search_type=3">申請{{$pu_count1}}件</a></li>
					@endif
				</ul>
				@endif
...
@if(Auth::user()->role!=3)
	...
	@endif
				...
				<ul>
					...
					<li><a href="/shinsei2/public/attendance/admin/search">打刻管理</a></li>
