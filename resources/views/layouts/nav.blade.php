		 ...
		 @if (Route::has('login'))
		 	@auth
				...
				<ul>
					...
					@if(Auth::user()->role==1)
					<li class="nav_count"><a href="/shinsei2/public/7/matter_ruling">購入申請(仮)</a>　　　　<a class="double" href="/shinsei2/public/7/matter_ruling?search_type=3">申請{{$ov_count1}}件</a></li>
					@endif
				</ul>
				@endif
